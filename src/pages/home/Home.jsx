  ...
  return (
    <>
        ...
        <div className="flex justify-center items-center gap-8">
          ...
          <div className=" w-2/3 flex justify-center items-center flex-col gap-5">
            <div className="flex items-center flex-col bg-paysparq p-5 rounded-lg">
              <span className="pb-7">
              <img src="/image/time-19.png" alt="" width={70}/>
              </span>
              <h1 className="text-xl font-interSB font-semibold pb-5 text-secondary">
                Best Rates Guaranteed
              </h1>
              <p className="text-center text-secondary text-lg">
              Trade digital assets, gift cards, and cryptocurrency instantly at unbeatable rates. Enjoy fast transactions, secure payments, competitive prices, and a seamless, hassle-free experience. Buy and sell with confidence, ensuring maximum value and convenience with every trade.
              </p>
            </div>
            <div className=" flex items-center flex-col bg-paysparq p-5 rounded-lg">
            <span className="pb-7">
              <img src="/image/smartphone-16.png" alt="" width={70}/>
              </span>
              <h1 className="text-xl font-interSB font-semibold pb-5 text-secondary">
                Instant Airtime Deals
              </h1>
              <p className="text-center text-secondary text-lg">
              Convert airtime to cash, purchase airtime, and send international airtime securely—all in one place. Enjoy fast, reliable service with no extra fees. Simplify your payments and transactions effortlessly today, with seamless support and top-notch security features.
              </p>
            </div>
          </div>
          <div>
          ...
          <div className=" w-2/3 flex justify-center items-center flex-col gap-5">
            <div className="flex items-center flex-col bg-paysparq p-5 rounded-lg">
            <span className="pb-6"> <PublicIcon style={{ fontSize: '4rem', color: '#F66B04' }}/></span>
              <h1 className="text-xl font-interSB font-semibold pb-5 text-secondary">
                Seamless Local & Global Transfers
              </h1>
              <p className="text-center text-secondary text-lg">
              Send money locally and internationally with ease. Enjoy fast, secure, and fee-free transfers anytime, anywhere. Make reliable transactions simple, with real-time tracking, full payment security, and instant delivery for a seamless experience every time. Fast, convenient, and trustworthy!
              </p>
            </div>
            <div className="flex items-center flex-col bg-paysparq p-5 rounded-lg">
              <span className="pb-6"><CurrencyExchangeIcon style={{ fontSize: '4rem', color: '#F66B04' }}/></span>
              <h1 className="text-xl font-interSB font-semibold pb-5 text-secondary">
              Exchange currency
              </h1>
              <p className="text-center text-secondary text-lg">
              Paysparq offers unbeatable exchange rates and ranks among Africa’s largest currency exchange platforms by volume. Enjoy fast, secure, and reliable transactions, making it the go-to platform for seamless currency exchange across the continent.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="w-fll justify-between items-center flex px-24 py-16">
        <div className="w-3/6">
          <h2 className="text-4xl font-interSB font-bold text-secondary">
            All-In-One Cryptocurrency Exchange for Your Trading Needs
          </h2>
          <p className="pt-4 tex-3xl font-interSB font-medium text-secondary">
        ...
        <div className="w-5/6 h-96 bg-primary-600 rounded-lg relative overflow-hidden">
          ...
          <div className=" px-20 relative flex items-center justify-between z-20">
            ...
            <div className="card w-2/4 flex flex-col items-center pb-48">
              <h1 className="text-white text-center text-4xl font-interB font-bold pb-3">
                Get your virtual USD card instantly!
              </h1>
              <p className=" text-center w-2/3 font-interSB text-xl text-white font-medium">
              ...
              <a
                href="#"
                className="outline-none focus:outline-none  mt-5 flex justify-center items-center gap-2 bg-secondary rounded-lg py-4 px-9 text-white text-center text-xl hover:shadow-lg hover:shadow-rose-500"
              >
      ...
      <div className="why-choose-us w-full py-16 px-24 bg-white">
        <div className="flex-col w-full flex justify-center items-center">
          ...
          <h1 className="mt-3 pt-5 text-5xl font-interSB font-bold text-secondary">
